...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      {/* 1. NEWS & UPDATES — First section after hero for freshness */}
      <section className="news-section" aria-label="Latest admissions and enrollment news">
        <h2 className="section-title">📰 Latest News &amp; Enrollment Updates</h2>
        <p className="section-subtitle">Registration deadlines, open houses, and enrollment news — updated March 2026.</p>

        {/* Urgent deadlines row */}
      ...
      {/* 2. BROWSE BY TYPE — organized category cards */}
